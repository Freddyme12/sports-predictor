...
CRITICAL: Show all math, be honest about limitations, educational purposes only`;
  ...
  // UPDATED: compileAllGameData is now async and includes model predictions
  ...
  // UPDATED: analyzeGame handles async compile and includes model predictions in prompt
